                    ...
                    @foreach ($catagories as $catagory)
                        <div class="col-lg-4 col-xl-3 col-md-6">
                            <div class="single_catagory">
                                <a href="jobs.html">
                                    <h4 class="pb-2">{{ $catagory->name }}</h4>
                                </a>
                                        ...
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('all.jobs.details', $featuredJob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                <p>{{ Str::words($letestJob->description, 5) }}</p>
                                                <div class="bg-light p-3 border">
                                                    <p class="mb-0">
                                                        <span class="fw-bolder"><i class="fa fa-map-marker"></i></span>
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('all.jobs.details', $letestJob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
