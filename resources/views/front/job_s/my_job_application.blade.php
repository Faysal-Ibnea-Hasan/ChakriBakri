                                        ...
                                        @if ($jobApplications->isNotEmpty())
                                            @foreach ($jobApplications as $jobApplication)
                                                <tr class="active">
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($jobApplication->job->applied_at)->format('d M, Y') }}
                                                    </td>
                                                        ...
                                                        <div class="action-dots float-end">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item"
                                                                        href="{{ route('all.jobs.details', $jobApplication->job_id) }}">
                                            ...
                                            @endforeach
                                        @else
                                            <td>You haven't applied for any job yet!</td>
                                        @endif
